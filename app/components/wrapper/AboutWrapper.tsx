    ...
    <AboutContainer>
        <MainContainer>
            <MainTextContainer className={exo.className} >
                <motion.div variants={variant} initial='startTit' whileInView='endTit' className='lg:shadW text-amber-50 flex text-[4.5rem] md:text-[6.7rem] flex-col lg:flex-row lg:text-[6.3rem] xl:text-[10rem] lg:gap-5'>La soluzione<p className='text-amber-400 lg:shad uppercase '>ideale</p></motion.div>
