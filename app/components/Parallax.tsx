    ...
    const yBg = useTransform( scrollYProgress , [0,1] ,["0%" , "50%"]);
      return (
        <section ref={ref} className="flex flex-col md:flex-row items-center justify-end lg:justify-center w-[100vw] min-h-[100vh]  image">
          <div className=" flex flex-col justify-start items-center md:mb-[-15rem] lg:ml-[30rem] md:ml-[1rem] ml-0 min-h-[8rem] font-black text-[3.5rem] md:text-[8rem] lg:text-[10rem] italic md:h-[10rem] text-amber-400 hover:text-amber-600 uppercase transition-all ease-in duration-[0.5] " >
